...
import { useRealtors, useProperty } from "@/hooks/useSupabaseData";
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center py-12">
            ...
            <Button asChild>
              <Link to="/admin/properties">Voltar para Imóveis</Link>
            </Button>
          </div>
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Popover open={isRealtorPopoverOpen} onOpenChange={setIsRealtorPopoverOpen}>
                      ...
                      <PopoverContent className="w-full p-0" align="start">
                        <Command>
                          ...
                          <CommandList>
                            <CommandEmpty>
                              {realtorsLoading ? "Carregando corretores..." : "Nenhum corretor encontrado."}
                            </CommandEmpty>
                            <CommandGroup>
                ...
                <div className="flex justify-end space-x-4">
                  <Button type="button" variant="outline" asChild>
                    <Link to="/admin/properties">Cancelar</Link>
                  </Button>
